...
run1_config = {"r" : 16,
               ...
               "output_dir": "gs://code-sentinel-2026-training/checkpoints/run1",
               "logging_steps": 50,
               "eval_steps": 500,
               "save_steps": 500,
               "fp16" : True,
               ...
               "train_data_path": "gs://code-sentinel-2026-training/data/processed-train.jsonl",
               "validation_data_path": "gs://code-sentinel-2026-training/data/processed-valid.jsonl"}
